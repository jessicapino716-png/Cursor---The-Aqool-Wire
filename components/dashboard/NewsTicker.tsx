...
export default function NewsTicker() {
  ...
  return (
    <div className="relative overflow-hidden border-y border-[#44403c] bg-[#1c1917]/60">
      <div className="absolute inset-y-0 left-0 w-16 bg-gradient-to-r from-[#1c1917] via-[#1c1917]/80 to-transparent pointer-events-none" />
      <div className="absolute inset-y-0 right-0 w-16 bg-gradient-to-l from-[#1c1917] via-[#1c1917]/80 to-transparent pointer-events-none" />

      <div className="flex items-center gap-3 border-r border-[#44403c] px-4 py-2 text-xs font-semibold tracking-[0.3em] text-[#78716c] uppercase">
        <Sparkles className="h-4 w-4 text-emerald-400" strokeWidth={1.5} />
        Wire Feed
      </div>

      <motion.div
        className="flex items-center gap-8 py-2 pl-4 font-mono text-sm text-[#a8a29e] whitespace-nowrap"
        animate={{ x: ['0%', '-50%'] }}
      ...
      >
        {loopedHeadlines.map((headline, index) => (
          <div
            ...
            className="flex items-center gap-3 border border-[#44403c] bg-[#292524]/60 px-4 py-1 rounded-full shadow-[0_0_20px_rgba(0,0,0,0.3)]"
          >
